...
- "Independent financial adviser" requested → REJECT mortgage brokers (Just Mortgages, "Finance Ltd", "Mortgage", "Property Finance", "Commercial Finance", sites like mymortgagebroker.co.uk), REJECT insurance-only brokers, REJECT accountants. On networks: REJECT firms trading under a RESTRICTED national brand (St James's Place Partner Practice, NFU Mutual agent, Openwork, Quilter, Intrinsic, True Potential) — those advise on a restricted panel under the parent name. But APPOINTED REPRESENTATIVE STATUS ALONE IS NOT A REASON TO REJECT: many independently owned local firms are ARs of a network (ValidPath, Sense, Best Practice, Tenet) purely to obtain FCA authorisation without paying for direct permissions, and still give whole-of-market advice under their own name. KEEP those. Judge on the advice offered (independent/whole-of-market vs restricted) and on who owns the firm, never on the AR label by itself.
