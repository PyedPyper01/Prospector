...
- INDEPENDENT only. For ADVICE firms the disqualifier is RESTRICTED ADVICE, which firms must disclose on their own site: reject St James's Place, M&G/Prudential, Schroders Personal Wealth, NFU Mutual, Openwork, Quilter, Intrinsic, True Potential and anyone advising on a single provider's panel. Appointed Representative status on its own is NOT a reason to reject — it is how many small independents obtain FCA authorisation, and funeral directors must be ARs to sell pre-paid plans. For other trades reject national chains, franchises and consolidators. Independence is about ownership and whole-of-market advice, never the AR label.
